...
if (get_theme_mod( 'seos_restaurant_gallery_activate' )) {  ?>
	...
	<div class="sr-gallery-section">
		...
		<?php if (get_theme_mod('seos_restaurant_gallery_section_title')) { ?> <h2><?php echo get_theme_mod('seos_restaurant_gallery_section_title'); ?></h2><?php } ?>
			...
			<?php for($i=1;$i<=20;$i++) {
				...
				if (get_theme_mod('seos_restaurant_image_gallery_'.$i)) { ?>
					...
					<div class="aniview"  data-av-animation="flipInX">					
						<a href="<?php echo get_theme_mod('seos_restaurant_image_gallery_link_'.$i); ?>">			
							<img alt="gallery-image-1" src="<?php echo get_theme_mod('seos_restaurant_image_gallery_'.$i); ?>" />
							<div class="sr-gallery-title animated zoomInDown"><?php echo get_theme_mod('seos_restaurant_image_title_'.$i); ?></div>
						</a>
					</div>
					</div>
